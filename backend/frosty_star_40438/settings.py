"""
Django settings for frosty_star_40438 project.
...
ROOT_URLCONF = 'frosty_star_40438.urls'
...
WSGI_APPLICATION = 'frosty_star_40438.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_star_40438 API",
    "DESCRIPTION": "API documentation for frosty_star_40438 App",
    "VERSION": "v1",
}
